...
3. variable - with the following values: These values are either mean or standard deviation of a measurement.
...
4. Value - this represents the mean of the test and train datasets for each subject, activity and measure.
